...
#  across different proportions (fixed magnitude of HTE -> medium)
#
...
# homepath <- "/home/pjiang/pmms/"
# setwd(homepath) # CHANGE THIS #
source("./utility.R")
...
output_dir <- paste0("./simulations/proportion/outputs/simulations_n", n, "_stratified", n.fold, "foldCV")
if (!dir.exists(output_dir)) dir.create(output_dir)
save(batchcv, paste0("./simulations/proportion/outputs/simulations_n", n, "_stratified", n.fold, "foldCV/simulations_n", n, "_stratified", n.fold, "foldCV_", method, "_", outcome,  "_batch", batch, "_beta", paste0(round(beta, 2), collapse = "-"), "_perc", paste0(percentiles, collapse = "-"), ".RData"))
