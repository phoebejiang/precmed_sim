...
wd <- paste0("./simulations/proportion/outputs/simulations_n", n, "_stratified10foldCV/")
...
for (result in results){
  ...
  for (name in names(batchcv)){
    ...
    # Retrieve slurm outputs to record the run time
    slurmoutput <- readLines(paste0('./simulations/proportion/code/slurmoutputs/slurm-simmain_n', n, '_', n.fold, 'folds/slurm-simmain_n', n, '_', n.fold, 'folds_', 
    ...
    if (length(realtime) == 0) realtime = "real 0s"
    ...
    if (length(elapsedtime) == 0) elapsedtime = "Time elapsed: 0s"
...
write_csv(vhats.dhat, paste0("./simulations/proportion/outputs/simmain_CV_results_vhats.dhat_n", n, "_stratified", n.fold, "folds_beta", paste0(beta, collapse = "-"), "_perc", paste0(percentiles, collapse = "-"), ".csv"))
write_csv(vs.dhat, paste0("./simulations/proportion/outputs/simmain_CV_results_vs.dhat_n", n, "_stratified", n.fold, "folds_beta", paste0(beta, collapse = "-"), "_perc", paste0(percentiles, collapse = "-"), ".csv"))
write_csv(dhats, paste0("./simulations/proportion/outputs/simmain_CV_results_dhats_n", n, "_stratified", n.fold, "folds_beta", paste0(beta, collapse = "-"), "_perc", paste0(percentiles, collapse = "-"), ".csv"))
write_csv(dhats.big, paste0("./simulations/proportion/outputs/simmain_CV_results_dhats.big_n", n, "_stratified", n.fold, "folds_beta", paste0(beta, collapse = "-"), "_perc", paste0(percentiles, collapse = "-"), ".csv"))
